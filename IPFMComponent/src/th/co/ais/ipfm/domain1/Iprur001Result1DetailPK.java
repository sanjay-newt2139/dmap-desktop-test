...
public class Iprur001Result1DetailPK implements Serializable {
    ...
    public String getDataSubject() { // DMAP Comment : Dead Code Detected - The Following Method has no reference getDataSubject
        return dataSubject;
    }

    public void setDataSubject(String dataSubject) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setDataSubject
        this.dataSubject = dataSubject;
    }
