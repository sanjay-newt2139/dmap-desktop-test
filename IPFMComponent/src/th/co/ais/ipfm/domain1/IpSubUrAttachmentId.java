 ...
 */
@Embeddable
public class IpSubUrAttachmentId  implements java.io.Serializable , Cloneable {
    ...
    public IpSubUrAttachmentId() {
    }

    public IpSubUrAttachmentId(String urNo, String subUrNo, BigDecimal seq, String category, String fileName) {
       this.urNo = urNo;
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof IpSubUrAttachmentId) ) return false;
		 IpSubUrAttachmentId castOther = ( IpSubUrAttachmentId ) other; 
 ...
 && ( (this.getCategory()==castOther.getCategory()) || ( this.getCategory()!=null && castOther.getCategory()!=null && this.getCategory().equals(castOther.getCategory()) ) );
   ...
   {
		IpSubUrAttachmentId another = (IpSubUrAttachmentId) super.clone();
