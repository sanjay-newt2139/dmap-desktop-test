...
public class IpvTodoReqnc implements Serializable, Cloneable {
	...
	public String getTitle2Ur() {
		return title2Ur;
	}

	public void setTitle2Ur(String title2Ur) {
		this.title2Ur = title2Ur;
	}

	public String getTitle2SubUr() {
		return title2SubUr;
	}

	public void setTitle2SubUr(String title2SubUr) {
	...
	public Date getWaitingPm() {
		return waitingPm;
	}

	public void setWaitingPm(Date waitingPm) {
