 ...
 */
@Embeddable
public class Iprur001Result1PK implements Serializable {
    ...
    public Iprur001Result1PK() {
    }

    public Iprur001Result1PK(String reportId, short groupSeq, short dataLevel, String userId) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Iprur001Result1PK)) {
            return false;
        }
        Iprur001Result1PK other = (Iprur001Result1PK) object;
