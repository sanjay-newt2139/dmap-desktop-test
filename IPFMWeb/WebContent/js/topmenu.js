...
var origInputObj = inputObj;
 ...
 while((inputObj = inputObj.offsetParent) != null){ 
	if(inputObj.parentNode.id=='ipflow_menu')topOfMenuReached=true; 
...
{ 
  dhtmlgoodies_menuObj = document.getElementById('ipflow_menu'); 
  ...
  for(var no=0;no<aTags.length;no++){          
	 ...
	 if(subUl.length>0 && aTags[no].parentNode.parentNode.parentNode.id != 'ipflow_menu'){ 
