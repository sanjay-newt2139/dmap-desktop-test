...
<rich:modalPanel id="IPSUR001_AttachFile" autosized="true" styleClass="contentform" height="100" minWidth="400" >
	<f:facet name="header">
		<h:panelGroup>
	...
	<f:facet name="controls">
    	<h:panelGroup>
            ...
            <rich:componentControl for="IPSUR001_AttachFile" attachTo="hidelink" operation="hide" event="onclick"/>
        </h:panelGroup>
    </f:facet>
								...
								<tr>
									<td>	
								   		<rich:fileUpload id="uploadAttachFile"
						             			fileUploadListener="#{userReqIPAction.uploadAttachFile}" 
						             			...
						             			<a4j:support event="onuploadcomplete" action="#{userReqIPAction.uploadComplete}" reRender="errorMsg,diagramTable,appFlowTable" />
						             			<f:param name="urNo" value="#{userReqIPBean.ipUrIpDetail.urNo}" />
						             			<f:param name="category" value="#{userReqIPBean.attachType}" />
						             			<f:param name="description" value="User Request IP Attachment" />
									...
									<tr>
										<td align="center">
											<a4j:commandButton value="Close" styleClass="rich-button" >
									    		<rich:componentControl for="IPSUR001_AttachFile" operation="hide" event="onclick" />
									    	</a4j:commandButton>
										</td>
									</tr>
								</table>
