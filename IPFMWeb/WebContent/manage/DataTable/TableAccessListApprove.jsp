...
<rich:simpleTogglePanel switchType="client" id="PolicyAccessListRequest" label="Policy Access List">
	<table width="97%" border="0" cellpadding="0" cellspacing="0"class="thtext_detail">
		<tr><td>
			<rich:dataTable width="100%" id="AccessListTable" cellpadding="1" cellspacing="0" border="0"
				...
				value="#{networkConfigBean.listAccessList}" var="firewall">
				<rich:column width="30%"  filterValue="#{networkConfigBean.filterTablAssign.filterColumn1}"  filterExpression="#{fn:containsIgnoreCase(firewall.urNo,networkConfigBean.filterTablAssign.filterColumn1)}"  style="vertical-align:top;">
					<f:facet name="header">
						
							  <h:panelGroup>
		 <h:outputText value="UR Sub ID" styleClass="contentform tableHeaderText"></h:outputText>
		 <h:inputText value="#{networkConfigBean.filterTablAssign.filterColumn1}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="PolicyAccessListRequest" />
		 </h:inputText>
	 </h:panelGroup>
					</f:facet>
				...
				<rich:column width="10%" style="vertical-align:top;">
					<f:facet name="header">
						<h:selectBooleanCheckbox value="1" id="approveAll" />
				...
				<rich:column width="10%" style="vertical-align:top;">
					<f:facet name="header">
						<h:selectBooleanCheckbox value="1" id="rejectAll" />
						<h:outputText value="Reject" styleClass="contentform tableHeaderText"></h:outputText>
					</f:facet>
					<div align="center">
						<h:selectBooleanCheckbox value="1" id="chkReject" />
					</div>
				</rich:column>
				<rich:column width="30%"  filterValue="#{networkConfigBean.filterTablAssign.filterColumn2}"  filterExpression="#{fn:containsIgnoreCase(firewall.source.ip,networkConfigBean.filterTablAssign.filterColumn2)}" >
					<f:facet name="header">
					
						 <h:panelGroup>
			<h:outputText value="Source IP" styleClass="contentform tableHeaderText"></h:outputText>
		 <h:inputText value="#{networkConfigBean.filterTablAssign.filterColumn2}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="PolicyAccessListRequest" />
		 </h:inputText>
	 </h:panelGroup>
					</f:facet>
					<h:panelGrid columns="2">
						...
						<h:outputLink value="#" id="link">
					        ...
					        <rich:componentControl for="ViewAccessList" attachTo="link" operation="show" event="onclick"/>
					    </h:outputLink>
				...
				<rich:column width="30%"  filterValue="#{networkConfigBean.filterTablAssign.filterColumn3}"  filterExpression="#{fn:containsIgnoreCase(firewall.dest.ip,networkConfigBean.filterTablAssign.filterColumn3)}" >
					<f:facet name="header">
							 <h:panelGroup>
		<h:outputText value="Destination IP" styleClass="contentform tableHeaderText"></h:outputText>
		 <h:inputText value="#{networkConfigBean.filterTablAssign.filterColumn3}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="PolicyAccessListRequest" />
		 </h:inputText>
	 </h:panelGroup>
					</f:facet>
				...
				<rich:column width="15%" style="vertical-align:top;">
					<f:facet name="header">
						<h:outputText value="Comment" styleClass="contentform tableHeaderText"></h:outputText>
					</f:facet>
					<div align="center">
						<h:inputTextarea id="approveComment"></h:inputTextarea>
					</div>
				</rich:column>
		...
		<tr><td width="760" align="right">
			<a4j:region renderRegionOnly="true">
				<h:panelGroup id="btnAccessListPolicyGroup">
					<a4j:commandButton id="btnAdd" value="Add" styleClass="rich-button"
						reRender="AddAccessListPopup">
						<rich:componentControl for="AddAccessListPopup" attachTo="btnAdd" operation="show" event="onclick"/>
					</a4j:commandButton>&nbsp;
