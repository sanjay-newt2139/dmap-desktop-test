	...
	<table width="97%" border="0" cellpadding="0" cellspacing="0"class="thtext_detail">
		<tr><td>
			<rich:dataTable width="100%" id="fierwallPolicyTable" cellpadding="1" cellspacing="0" border="0"
				...
				<rich:column width="30%"  filterValue="#{networkConfigBean.filterTablView.filterColumn1}"  filterExpression="#{fn:containsIgnoreCase(firewall.urNo,networkConfigBean.filterTablView.filterColumn1)}"  style="vertical-align:top;">
					<f:facet name="header">
						
							  <h:panelGroup>
		 <h:outputText value="UR Sub ID" styleClass="contentform tableHeaderText"></h:outputText>
		 <h:inputText value="#{networkConfigBean.filterTablView.filterColumn1}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="fierwallPolicyTable" />
				...
				<rich:column width="20%"  filterValue="#{networkConfigBean.filterTablView.filterColumn2}"  filterExpression="#{fn:containsIgnoreCase(firewall.source.ip,networkConfigBean.filterTablView.filterColumn2)}" >
					<f:facet name="header">
					
						  <h:panelGroup>
		 	<h:outputText value="Source IP" styleClass="contentform tableHeaderText"></h:outputText>
		 <h:inputText value="#{networkConfigBean.filterTablView.filterColumn2}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="fierwallPolicyTable" />
		 </h:inputText>
	 </h:panelGroup>
					</f:facet>
				...
				<rich:column width="20%"  filterValue="#{networkConfigBean.filterTablView.filterColumn3}"  filterExpression="#{fn:containsIgnoreCase(firewall.dest.ip,networkConfigBean.filterTablView.filterColumn3)}" >
					<f:facet name="header">
						  <h:panelGroup>
						<h:outputText value="Destination IP" styleClass="contentform tableHeaderText"></h:outputText>
		 <h:inputText value="#{networkConfigBean.filterTablView.filterColumn3}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="fierwallPolicyTable" />
		 </h:inputText>
	 </h:panelGroup>
					</f:facet>
				...
				<rich:column width="15%"  filterValue="#{networkConfigBean.filterTablView.filterColumn4}"  filterExpression="#{fn:containsIgnoreCase(firewall.service.serviceName,networkConfigBean.filterTablView.filterColumn4)}"  style="vertical-align:top;">
					<f:facet name="header">
						  <h:panelGroup>
						<h:outputText value="Service" styleClass="contentform tableHeaderText"></h:outputText>
		 <h:inputText value="#{networkConfigBean.filterTablView.filterColumn4}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="fierwallPolicyTable" />
		 </h:inputText>
	 </h:panelGroup>
					</f:facet>
