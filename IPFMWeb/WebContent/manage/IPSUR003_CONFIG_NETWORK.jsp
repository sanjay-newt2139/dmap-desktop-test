...
<f:view>
					...
					<table width="97%" border="0" bgcolor="#CCCCCC" class="thtext_detail2">
					   <tr>
                             <td height="25" background="../images/title_bar.png" align="left"
								...
								class="style9">Config Network</span></strong></td>
					  </tr>				  
							...
							<rich:simpleTogglePanel switchType="client" id="reqProfile" label="Requester Profile" >	
								<table width="97%" border="0" class="thtext_detail">
								    <tr class="displayRow">
										...
										<td  class="labelStyle"><strong>Session :</strong>&nbsp;</td>
						...
						<tr>
							<td>
								...
								<rich:tabPanel switchType="ajax" id="policyTab">
									<rich:tab id="tbFirewall" label="Firewall" binding="#{tabControlAction.tabFirewall}">
										<a4j:include viewId="DataTable/IPSUR003_NETWORK_CONFIG_FIREWALL.jsp"/>
									</rich:tab>
									<rich:tab id="tbAccessList" label="Access List For CDN" binding="#{tabControlAction.tabAccessList}" >
										<a4j:include viewId="DataTable/IPSUR003_NETWORK_CONFIG_ACCESS_LIST.jsp"/>
									</rich:tab>
									<rich:tab id="tbPhysical" label="Physical Interface" binding="#{tabControlAction.tabPhysical}" >
										<a4j:include viewId="DataTable/IPSUR003_NETWORK_CONFIG_PHYSICAL_INTERFACE.jsp"/>
									</rich:tab>
								...
								<table width="97%" border="0" cellspacing="0" cellpadding="0">								 
									...
									<td align="right">
										<h:panelGroup id="buttonGroup">
									    	<a4j:commandButton id="btnApprove" value="Submit" styleClass="rich-button"
												action="#{reqNWConfigAction.viewAssign}"
	...
	<jsp:directive.include file="popup/popupAssignByPM.jsp"/>
	<jsp:directive.include file="popup/popupAssignDetail.jsp"/>
</f:view>
</body>
</html>
