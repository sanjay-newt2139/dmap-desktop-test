					...
					<table width="97%" border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC" class="thtext_detail2">
					   <tr>
                             <td height="25" background="../images/title_bar.png" align="left"
								...
								class="style9"></span>Worflow Management</strong></td>
					  </tr>
					  <tr>
									...
									<tr>
										   ...
										   <td>
				          						...
				          						<a4j:commandButton id="btnplanRequestIp" value="IP Detail" 
													image="../images/tab_planning_req_notactive.png" style="height: 25; width: 135" 
									...
									<table width="97%" border="0" cellpadding="0" cellspacing="0" class="thtext_detail">
										<tr>
											<td width="15%" height="25" align="center">
											      <h:graphicImage value="../images/network_req_1.jpg" style="border:0;width: 1000px;height: 350px"/>
											</td>
                                        </tr> 
                                        <tr>
                                        ...
                                        <tr>
											<td width="15%" height="25" align="center">
											      <h:graphicImage value="../images/network_req_2.jpg" style="border:0;width: 1000px;height: 350px"/>
											</td>
                                        </tr>  
                                        <tr>
											<td  height="25" align="center">   
                                        ...
                                        <tr>
											<td width="15%" height="25" align="center">
											      <h:graphicImage value="../images/network_req_3.jpg" style="border:0;width: 1000px;height: 350px"/>
											</td>
                                        </tr>                                                           
								    </table>
							   </rich:panel>
									...
									<table width="70%" border="0" cellpadding="0" cellspacing="0" class="thtext_detail" bordercolor="#CCCCCC">
										<tr>
											...
											<td height="25" align="left" >
												<strong><h:outputText value="N7-Request NetworkConfig"></h:outputText></strong>
											</td>  
                                        </tr>
                                        <tr>
											<td width="10%" height="25" align="right" >
