								...
								<a4j:form id="CriteriaForm">
								 <rich:panel id="groupSearchCriteria" >	
									<table width="97%" border="0" class="thtext_detail">
										<tr class="inputRow">
											<td class="labelStyle" height="25"><strong>Master Setup Table<h:graphicImage value="../images/icon_required.gif" style="border:0" />&nbsp;:&nbsp;</strong></td>
											<td align="left" >
                                                 <rich:comboBox id="referTable" enableManualInput="false"  
													styleClass="contentform" itemClass="contentform" itemSelectedClass="contentform" 
													value="#{masterTableBean.refKeyComboItem}"  width="300">
												     <f:attribute name="selectItems" value="#{masterTableBean.refTableList}"/>
												     <f:selectItems value="#{masterTableBean.refTableList}"/>
													<a4j:support reRender="groupSearchCriteria, resultPanel" event="onchange" action="#{masterTableAction.changeRefKey}" />
												 </rich:comboBox>
											</td>
										</tr>
										...
										<h:panelGroup rendered="#{masterTableBean.displayHolidays}">
											<tr class="inputRow">
												...
												<td align="left" >
													 <h:inputText value="#{masterTableBean.masterTBL.holidayDate}" size="17" readonly="true" rendered="#{masterTableBean.disabledForEdit}"> 
													 	<f:convertDateTime pattern="dd/MM/yyyy"/>
													 </h:inputText>
	                                                 <rich:calendar value="#{masterTableBean.masterTBL.holidayDate}" 
										                        locale="en/US" rendered="#{!masterTableBean.disabledForEdit}"
										                        popup="true"
										...
										<h:panelGroup rendered="#{masterTableBean.displayLogo}">
											<tr class="inputRow" >
												...
												<td align="left" >
													 <rich:fileUpload fileUploadListener="#{masterTableAction.listener}"
										...
										<tr>
										   <td align="left" colspan="3">
										   		<a4j:commandButton id="btnAdd" value="Add" styleClass="rich-button" 
										   			action="#{masterTableAction.createMasterTBL}" 
												...
												<rich:spacer width="10" rendered="#{masterTableBean.displayForCreate}"/>
										      	<a4j:commandButton id="btnSave" value="Save" styleClass="rich-button" 
										      		action="#{masterTableAction.updateMasterTBL}" 
										      		reRender="CriteriaForm,errorMsg"
										      		rendered="#{masterTableBean.displayForEdit}">
												</a4j:commandButton>
												<rich:spacer width="10" />
										      	<a4j:commandButton id="btnCancel" value="Cancel" styleClass="rich-button" 
										      		actionListener="#{masterTableAction.cancel}" reRender="CriteriaForm,errorMsg"
										      		rendered="#{masterTableBean.displayForEdit}" />&nbsp;
										  </td>
										</tr>
										</h:panelGroup>
									...
									<rich:panel rendered="#{!masterTableBean.displayNews && !masterTableBean.displayLogo}">	
										<rich:dataTable width="100%" id="masterTable" cellpadding="1" cellspacing="0" border="0"
											...
											headerClass="tableHeader">
												<rich:column width="5%">
													...
													<div align="center">
                                                          <a4j:commandButton id="btnUpd" value="Update" 
															...
															actionListener="#{masterTableAction.editProperty}">
												...
												<rich:column  filterValue="#{masterTableBean.filter001.filterColumn1}"  filterExpression="#{fn:containsIgnoreCase(masterTbl.id.refTable,masterTableBean.filter001.filterColumn1)}"   width="15%">
													<f:facet name="header">														
														  <h:panelGroup>
		 <h:outputText value="Master Setup Table" styleClass="contentform tableHeaderText" />
		 <h:inputText value="#{masterTableBean.filter001.filterColumn1}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="masterTable" />
												...
												<rich:column  filterValue="#{masterTableBean.filter001.filterColumn2}"  filterExpression="#{fn:containsIgnoreCase(masterTbl.shortDesc,masterTableBean.filter001.filterColumn2)}"   width="15%"  rendered="#{masterTableBean.displayOther}">
													<f:facet name="header">														
														 <h:panelGroup>
		 <h:outputText value="Display Name" styleClass="contentform tableHeaderText" />
		 <h:inputText value="#{masterTableBean.filter001.filterColumn2}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="masterTable" />
		 </h:inputText>
	 </h:panelGroup>
													</f:facet>
												...
												<rich:column  filterValue="#{masterTableBean.filter001.filterColumn3}"  filterExpression="#{fn:containsIgnoreCase(masterTbl.shortDesc,masterTableBean.filter001.filterColumn3)}"   width="20%" rendered="#{masterTableBean.displayService}">
													<f:facet name="header">
														
														<h:panelGroup>
										 <h:outputText value="Service Name" styleClass="contentform tableHeaderText" />
		 <h:inputText value="#{masterTableBean.filter001.filterColumn3}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="masterTable" />
		 </h:inputText>
	 </h:panelGroup>
													</f:facet>
												...
												<rich:column  filterValue="#{masterTableBean.filter001.filterColumn4}"  filterExpression="#{fn:containsIgnoreCase(masterTbl.tcp,masterTableBean.filter001.filterColumn4)}"   width="20%" rendered="#{masterTableBean.displayService}">
													<f:facet name="header">
														
															<h:panelGroup>
										 <h:outputText value="TCP" styleClass="contentform tableHeaderText" />
		 <h:inputText value="#{masterTableBean.filter001.filterColumn4}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="masterTable" />
		 </h:inputText>
	 </h:panelGroup>
													</f:facet>
												...
												<rich:column  filterValue="#{masterTableBean.filter001.filterColumn5}"  filterExpression="#{fn:containsIgnoreCase(masterTbl.udp,masterTableBean.filter001.filterColumn5)}"   width="20%" rendered="#{masterTableBean.displayService}">
													<f:facet name="header">
														<h:panelGroup>
										 <h:outputText value="UDP" styleClass="contentform tableHeaderText" />
		 <h:inputText value="#{masterTableBean.filter001.filterColumn5}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="masterTable" />
		 </h:inputText>
	 </h:panelGroup>
													</f:facet>
												...
												<rich:column  filterValue="#{masterTableBean.filter001.filterColumn6}"  filterExpression="#{fn:containsIgnoreCase(masterTbl.other,masterTableBean.filter001.filterColumn6)}"   width="20%" rendered="#{masterTableBean.displayService}">
													<f:facet name="header">
														<h:panelGroup>
										 <h:outputText value="Other" styleClass="contentform tableHeaderText" />
		 <h:inputText value="#{masterTableBean.filter001.filterColumn6}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="masterTable" />
		 </h:inputText>
	 </h:panelGroup>
													</f:facet>
												...
												<rich:column  filterValue="#{masterTableBean.filter001.filterColumn7}"  filterExpression="#{fn:containsIgnoreCase(masterTbl.refDesc,masterTableBean.filter001.filterColumn7)}"  width="50%" rendered="#{!masterTableBean.displayService}">
													<f:facet name="header">
														<h:panelGroup>
										 <h:outputText value="Description" styleClass="contentform tableHeaderText" />
		 <h:inputText value="#{masterTableBean.filter001.filterColumn7}" style="width: 50px;">
			 <a4j:support event="onblur" reRender="masterTable" />
		 </h:inputText>
	 </h:panelGroup>
													</f:facet>
