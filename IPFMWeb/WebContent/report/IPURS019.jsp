					...
					<table width="97%" border="0" cellspacing="0" cellpadding="0" bgcolor="#CCCCCC" class="thtext_detail2">
					   <tr>
                             <td height="25" background="../images/title_bar.png" align="left"
								...
								class="style9">Total Summary UR By User Request IP Report</span></strong></td>
					  </tr>
					  <tr>
							...
							<td>
							    <rich:panel id="panelGrop" >
									...
									<tr>
										...
										<td width="110" align="right" ><rich:spacer height="0"/></td>
                                  ...
                                  <tr>
                                   <td align="right"><strong>Request Date From :</strong>&nbsp;</td>
                                   <td align="left">    
                                         <rich:calendar value=""
							                        locale="en/US"
							                        popup="true"
									...
									<td width="550" align="right" >
										<h:panelGroup id="buttonGroup">
									    	<a4j:commandButton id="btnSaveDraft" value="Run Report" styleClass="rich-button"
												...
												reRender="DetailForm" >
												<a4j:actionparam name="programIDParam" value="IPURS021"/>
										    </a4j:commandButton>&nbsp;
