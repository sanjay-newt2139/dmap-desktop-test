...
<f:subview id="popupModalSubview_layout"> 
<rich:modalPanel id="IPRUR003_Report_Layout" autosized="true" binding="#{ipReportDetailBean.popupModal}"
	styleClass="contentform"  height="400" minWidth="400" label="Report Layout">
	<f:facet name="header">
		<h:panelGroup>
		...
		<td>
			...
			<div style="float:right;">	
				<a4j:commandButton value="Close" styleClass="rich-button" immediate="true">
					<rich:componentControl for="IPRUR003_Report_Layout" operation="hide" event="onclick" />
				</a4j:commandButton>			
			</div>
		</td>
		</tr>
