...
/**
DMAP TAG: Query converted Needs Manual Intervention : Identifier425
DMAP ConvertedQuery - SELECT coalesce(MAX(CAST(T1.SUB_UR_NO AS numeric)), 0) AS MAX_SUB_UR_NO FROM IP_UR_INTERFACE_GATEWAY T1 WHERE T1.UR_NO='urNo.trim()'
**/
	...
	@Override
	public IpUrInterfaceGateway getID(IpUrInterfaceGatewayId id) { // DMAP Comment : Dead Code Detected - The Following Method has no reference getID
		Session session = getSessionFactory().getCurrentSession();
		Criteria criteria = session.createCriteria(IpUrInterfaceGateway.class);
...
/**
DMAP TAG: Query converted but found same: Identifier424
DMAP ConvertedQuery - DELETE FROM IP_UR_INTERFACE_GATEWAY IG WHERE IG.UR_NO=?
**/
	...
	@Override
	public String getNetworkTypeId(String desc) { // DMAP Comment : Dead Code Detected - The Following Method has no reference getNetworkTypeId
		Session session = getSessionFactory().getCurrentSession();
		Criteria criteria = session.createCriteria(IpMasterTable.class);
...
/**
DMAP TAG: Query converted but found same: Identifier423
DMAP ConvertedQuery - UPDATE IP_UR_INTERFACE_GATEWAY set IS_IMPACT='N' WHERE UR_NO=?
**/
	...
	public void delete(String urNo, String subUrNo) { // DMAP Comment : Dead Code Detected - The Following Method has no reference delete
		Session session = getSessionFactory().getCurrentSession();
String sql = "DELETE FROM IP_UR_INTERFACE_GATEWAY FW WHERE FW.UR_NO=? AND FW.SUB_UR_NO IN (" + subUrNo + ")";//String sql = "DELETE FROM IP_UR_INTERFACE_GATEWAY FW WHERE FW.UR_NO=? AND FW.SUB_UR_NO IN ("+subUrNo+")";
/**
DMAP TAG: Query converted: Identifier422
DMAP ConvertedQuery - DELETE FROM IP_UR_INTERFACE_GATEWAY FW WHERE FW.UR_NO=? AND FW.SUB_UR_NO IN (subUrNo)
**/
	...
	@Override
	public void updateSubUrStatus(IpUrInterfaceGatewayId id, String status,IpUser user) { // DMAP Comment : Dead Code Detected - The Following Method has no reference updateSubUrStatus
		Session session = getSessionFactory().getCurrentSession();
...
/**
DMAP TAG: Query converted Needs Manual Intervention : Identifier421
DMAP ConvertedQuery - update IP_UR_INTERFACE_GATEWAY set SUB_UR_STATUS=? , UPDATE_BY=? , UPDATE_DATE=statement_timestamp() WHERE (SUB_UR_NO=? and UR_NO=?)
**/
	...
	@Override
	public boolean hasNetworkType(String type) { // DMAP Comment : Dead Code Detected - The Following Method has no reference hasNetworkType
		Session session = getSessionFactory().getCurrentSession();
		Criteria criteria = session.createCriteria(IpMasterTable.class);
		criteria.add(Restrictions.eq("id.refTable", "NW_TYPE"));
...
/**
DMAP TAG: Query converted but found same: Identifier420
DMAP ConvertedQuery - DELETE from IP_UR_INTERFACE_GATEWAY WHERE (UR_NO=?) AND (CHANGE_TYPE=?)
**/
...
/**
DMAP TAG: Query converted Needs Manual Intervention : Identifier419
DMAP ConvertedQuery - UPDATE IP_UR_INTERFACE_GATEWAY SET CHANGE_TYPE = NULL WHERE (UR_NO=?) AND (CHANGE_TYPE=?)
**/
	...
	@Override
	public List<IpUrInterfaceGateway> waitDeleteUr(String urNo) { // DMAP Comment : Dead Code Detected - The Following Method has no reference waitDeleteUr
		Session session = getSessionFactory().getCurrentSession();
		Criteria criteria = session.createCriteria(IpUrInterfaceGateway.class);
		criteria.add(Restrictions.eq("id.urNo", urNo));
	...
	@Override
	public IpUrInterfaceGateway fineIpUrInterfaceGateway(String urNo,String subUrNo) { // DMAP Comment : Dead Code Detected - The Following Method has no reference fineIpUrInterfaceGateway
		Session session = getSessionFactory().getCurrentSession();
		Criteria criteria = session.createCriteria(IpUrInterfaceGateway.class);
		criteria.add(Restrictions.eq("id.urNo", urNo));
