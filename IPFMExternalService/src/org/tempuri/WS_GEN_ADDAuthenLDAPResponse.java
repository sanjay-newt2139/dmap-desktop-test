...
public class WS_GEN_ADDAuthenLDAPResponse  implements java.io.Serializable {
     ...
     */
    public void setWS_GEN_ADDAuthenLDAPResult(org.tempuri.WS_GEN_ADDAuthenLDAPResponseWS_GEN_ADDAuthenLDAPResult WS_GEN_ADDAuthenLDAPResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setWS_GEN_ADDAuthenLDAPResult
        this.WS_GEN_ADDAuthenLDAPResult = WS_GEN_ADDAuthenLDAPResult;
    }
