...
public class ListEmployeeProfileByPIN_Input_DataSetByPowerSearch  implements java.io.Serializable {
     ...
     * @param ds
     */
    public void setDs(org.tempuri.ListEmployeeProfileByPIN_Input_DataSetByPowerSearchDs ds) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setDs
        this.ds = ds;
    }
