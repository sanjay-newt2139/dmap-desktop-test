...
public class SearchEmployeeOrgResponse  implements java.io.Serializable {
     ...
     */
    public void setSearchEmployeeOrgResult(org.tempuri.SearchEmployeeOrgResponseSearchEmployeeOrgResult searchEmployeeOrgResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setSearchEmployeeOrgResult
        this.searchEmployeeOrgResult = searchEmployeeOrgResult;
    }
