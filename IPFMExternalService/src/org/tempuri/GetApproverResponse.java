...
public class GetApproverResponse  implements java.io.Serializable {
     ...
     */
    public void setGetApproverResult(org.tempuri.GetApproverResponseGetApproverResult getApproverResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setGetApproverResult
        this.getApproverResult = getApproverResult;
    }
