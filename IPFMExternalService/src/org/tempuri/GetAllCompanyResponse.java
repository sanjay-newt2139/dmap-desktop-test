...
public class GetAllCompanyResponse  implements java.io.Serializable {
     ...
     */
    public void setGetAllCompanyResult(org.tempuri.GetAllCompanyResponseGetAllCompanyResult getAllCompanyResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setGetAllCompanyResult
        this.getAllCompanyResult = getAllCompanyResult;
    }
