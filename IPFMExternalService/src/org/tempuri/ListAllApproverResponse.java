...
public class ListAllApproverResponse  implements java.io.Serializable {
     ...
     */
    public void setListAllApproverResult(org.tempuri.ListAllApproverResponseListAllApproverResult listAllApproverResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setListAllApproverResult
        this.listAllApproverResult = listAllApproverResult;
    }
