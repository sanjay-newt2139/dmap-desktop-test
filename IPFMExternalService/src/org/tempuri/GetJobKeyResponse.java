...
public class GetJobKeyResponse  implements java.io.Serializable {
     ...
     */
    public void setGetJobKeyResult(org.tempuri.GetJobKeyResponseGetJobKeyResult getJobKeyResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setGetJobKeyResult
        this.getJobKeyResult = getJobKeyResult;
    }
