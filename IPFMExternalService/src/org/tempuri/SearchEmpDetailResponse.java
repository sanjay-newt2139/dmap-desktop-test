...
public class SearchEmpDetailResponse  implements java.io.Serializable {
     ...
     */
    public void setSearchEmpDetailResult(org.tempuri.SearchEmpDetailResponseSearchEmpDetailResult searchEmpDetailResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setSearchEmpDetailResult
        this.searchEmpDetailResult = searchEmpDetailResult;
    }
