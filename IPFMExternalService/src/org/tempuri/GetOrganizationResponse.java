...
public class GetOrganizationResponse  implements java.io.Serializable {
     ...
     */
    public void setGetOrganizationResult(org.tempuri.GetOrganizationResponseGetOrganizationResult getOrganizationResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setGetOrganizationResult
        this.getOrganizationResult = getOrganizationResult;
    }
