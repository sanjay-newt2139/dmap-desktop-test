...
public class GetEmployeeProfileByPrefixOrgnameResponse  implements java.io.Serializable {
     ...
     */
    public void setGetEmployeeProfileByPrefixOrgnameResult(org.tempuri.GetEmployeeProfileByPrefixOrgnameResponseGetEmployeeProfileByPrefixOrgnameResult getEmployeeProfileByPrefixOrgnameResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setGetEmployeeProfileByPrefixOrgnameResult
        this.getEmployeeProfileByPrefixOrgnameResult = getEmployeeProfileByPrefixOrgnameResult;
    }
