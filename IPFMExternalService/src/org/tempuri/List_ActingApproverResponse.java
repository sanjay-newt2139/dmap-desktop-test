...
public class List_ActingApproverResponse  implements java.io.Serializable {
     ...
     */
    public void setList_ActingApproverResult(org.tempuri.List_ActingApproverResponseList_ActingApproverResult list_ActingApproverResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setList_ActingApproverResult
        this.list_ActingApproverResult = list_ActingApproverResult;
    }
