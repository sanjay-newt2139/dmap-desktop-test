...
public class ListOrganize  implements java.io.Serializable {
     ...
     * @param lowerOrgCode
     */
    public void setLowerOrgCode(java.lang.String lowerOrgCode) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setLowerOrgCode
        this.lowerOrgCode = lowerOrgCode;
    }
     ...
     * @param higherOrgCode
     */
    public void setHigherOrgCode(java.lang.String higherOrgCode) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setHigherOrgCode
        this.higherOrgCode = higherOrgCode;
    }
