...
public class List_Log_OM_TransFormResponse  implements java.io.Serializable {
     ...
     */
    public void setList_Log_OM_TransFormResult(org.tempuri.List_Log_OM_TransFormResponseList_Log_OM_TransFormResult list_Log_OM_TransFormResult) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setList_Log_OM_TransFormResult
        this.list_Log_OM_TransFormResult = list_Log_OM_TransFormResult;
    }
