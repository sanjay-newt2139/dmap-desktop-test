 ...
 */
public class CustomNTLM2Engine {
     ...
     */
    String getType1Message(String host, String domain) throws AuthenticationException {
    ...
    private static int readUShort(byte[] src, int index) throws AuthenticationException {
     ...
     */
    private static byte[] lmResponse(byte[] hash, byte[] challenge) throws AuthenticationException {
        try {
    ...
    static class NTLMMessage {
        ...
        protected int readUShort(int position) throws AuthenticationException {
            return CustomNTLM2Engine.readUShort(messageContents, position);
        }

        /** Read a ulong from a position within the message buffer */
        protected int readULong(int position) throws AuthenticationException {
            return CustomNTLM2Engine.readULong(messageContents, position);
        }

        /** Read a security buffer from a position within the message buffer */
        protected byte[] readSecurityBuffer(int position) throws AuthenticationException {
            return CustomNTLM2Engine.readSecurityBuffer(messageContents, position);
        }
    ...
    static class Type2Message extends NTLMMessage {
        ...
        Type2Message(String message) throws AuthenticationException {
            super(message, 2);
