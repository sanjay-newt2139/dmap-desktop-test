...
public class CustomNegotiateCallbackHandler implements CallbackHandler {
     ...
     */
    public CustomNegotiateCallbackHandler() {
    }

    public CustomNegotiateCallbackHandler(String user, String password) {
        username = user;
    ...
    public void handle(Callback[] callbacks) // DMAP Comment : Dead Code Detected - The Following Method has no reference handle
        ...
        for (int i = 0; i < callbacks.length; i++) {
            if (callbacks[i] instanceof TextOutputCallback) {
                ...
                //  username =System.getProperty("com.jivesoftware.spintegration.communication.krb5.user");
