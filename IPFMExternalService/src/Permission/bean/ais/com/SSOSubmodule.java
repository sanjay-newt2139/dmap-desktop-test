...
public class SSOSubmodule  implements java.io.Serializable {
     ...
     * @param subModuleName
     */
    public void setSubModuleName(java.lang.String subModuleName) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setSubModuleName
        this.subModuleName = subModuleName;
    }
     ...
     * @param subModuleDesc
     */
    public void setSubModuleDesc(java.lang.String subModuleDesc) { // DMAP Comment : Dead Code Detected - The Following Method has no reference setSubModuleDesc
        this.subModuleDesc = subModuleDesc;
    }
